	...
	function reg(){
		...
		for(var i = 1; i <6; i = i+1){
			if (document.getElementById('date_timepicker_start'+i).value != '') {
				$(opener.document).find('#mylist li:nth-child('+i+')').text(document.getElementById('date_timepicker_start'+i).value + ' ~ ' + document.getElementById('date_timepicker_end'+i).value);
				$(opener.document).find('#pick'+i).val(document.getElementById('date_timepicker_start'+i).value + ' ~ ' + document.getElementById('date_timepicker_end'+i).value);
			} else {
				$(opener.document).find('#mylist li:nth-child('+i+')').text('일정 '+ i);
				$(opener.document).find('#pick'+i).val('');
			}
		}
