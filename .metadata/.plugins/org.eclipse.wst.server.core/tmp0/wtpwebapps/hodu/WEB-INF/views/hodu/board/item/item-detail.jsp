					...
					<div
						...
						<div class="templatemo-content">
							<div class="content_info">
								...
								<!-- 가격 -->
								<p
									style="background-color: #f7f7f7; border-radius: 6px; border: 1px solid; border-style: thin; border-color: #eee;">
									&nbsp;&nbsp;<strong>${dto.item_price }</strong> <img
										src="${pageContext.request.contextPath}/resources/assets/image/hoduC.png"
										style="width: 3%; vertical-align: top; margin-top: -3px">&nbsp;&nbsp;
								</p>
								<p>|</p>
...
<!-- 								<div class="container">	
            ...
            <div class="container-fluid">
				...
				<div class="image-section">
					<div class="image-container">
						<img
							src="/project/resources/assets_detail/image_slide/templatemo-bg-1.jpg"
							id="templatemo-page1-img" class="main-img inactive" alt="PHOTO">
						<img
							src="/project/resources/assets_detail/image_slide/templatemo-bg-2.jpg"
							id="templatemo-page2-img" class="inactive" alt="멘토 소개"> <img
							src="/project/resources/assets_detail/image_slide/templatemo-bg-3.jpg"
							id="templatemo-page3-img" class="inactive" alt="수업 소개"> <img
							src="/project/resources/assets_detail/image_slide/templatemo-bg-4.jpg"
							id="templatemo-page4-img" class="inactive" alt="추천 대상"> <img
							src="/project/resources/assets_detail/image_slide/templatemo-bg-5.jpg"
							id="templatemo-page5-img" class="inactive" alt="진행 방식"> <img
							src="/project/resources/assets_detail/image_slide/templatemo-bg-6.jpg"
							id="templatemo-page6-img" class="inactive" alt="리뷰">
					</div>
				</div>
				...
				<div class="row">
					<div
						class="col-lg-12 col-md-12 col-sm-12 col-xs-12 templatemo-content-wrapper border_content">
									...
									<div class="col-sm-8 col-md-8">
										...
										<div id="slider" class="flexslider">
											<ul class="slides">
												...
												<!-- 썸네일 이미지 -->
												<li><img
													src="/project/upload/Thumbnail/${dto.item_thumbnailimg}" />
												</li>
							...
							<section id="templatemo-page2-text" class="inactive">
								<div class="col-sm-6 col-md-6">
									...
									<div class="profile">
										...
										<!-- 멘토 프로필 이미지 -->
										<p class="profile_img">
											<img src="/project/upload/member/${dto.member_img}" alt="" />
										</p>
								...
								<div class="templatemo-content">
									<div class="sidenav">
										...
										<span class="like-content"> <!-- 찜하기(하트) --> <c:choose>
												<c:when
													test="${dto.likeStatue eq 'N' or empty dto.likeStatue}">
													<!-- likecheck가0이면 빈하트-->
												...
												<c:otherwise>
													<!-- likecheck가1이면 빨간 하트-->
													<button class="btn-secondary like-review" id="like2"
														onclick="changeHeart();">
														<i class="fa fa-heart" aria-hidden="true"></i> <br>
														<p>${dto.item_like }</p>
													</button>
											...
											<button class="btn-secondary like-review" id="order"
												onclick="yetlogin();">수업 신청하기</button>
	...
	function yetlogin(){ 
			...
			var link1 = '/project/hodu/payment/cart?item_code=' + ${dto.item_code } ;
	...
	function modifyBtn() {
		window.location.href = '/project/hodu/board/item/item-modify?item_code='+ '${dto.item_code}';
			...
			<script
				src="${pageContext.request.contextPath}/resources/assets_detail/js/jquery.min.js"></script>
			<script
				src="${pageContext.request.contextPath}/resources/assets_detail/js/jquery.backstretch.min.js"></script>
			<script
				src="${pageContext.request.contextPath}/resources/assets_detail/js/jquery.flexslider.min.js"></script>
			<script
