	                        ...
	                        <tbody class="t-control">
	                            ...
	                            <tr>
	                                ...
	                                <td class="qty mt-5">
				                        ...
				                        <input type="number" id = "item_num_of_people" name="item_NOP" class="count"  value= <c:out value="${dto.item_num_of_people }" /> readonly="readonly">
				                        <span class="plus">＋</span>	                          
	                                </td>
	                            </tr>    
                                <tr>
	                                <td class="t-title"><strong>회차 당 가격</strong></td>
	                                <td><input type="number" id = "item_price" class="form-control input-sm" name="item_price" value= <c:out value="${dto.item_price }" /> min="1" max="1000" onchange="this.value = Math.floor(Math.max(this.value,1)); this.value = Math.floor(Math.min(this.value,1000));" style="text-align:right;" /> <strong>&emsp;호두 </strong><img src="/project/resources/assets/image/favicon.ico"></td>
	                            </tr>		                            
	                            <tr>
