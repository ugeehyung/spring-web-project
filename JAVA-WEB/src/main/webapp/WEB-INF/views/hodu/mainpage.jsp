					...
					<section id="category" class="main">
						<div class="spotlight">
							<div class="content">
								...
								<ul class="actions">
									<li><a href="#"><i class="fab fa-hotjar"></i></a></li>
									<li><a href="#"><i class="fa fa-dumbbell"></i></a></li>
									<li><a href="#"><i class="fa fa-home"></i></a></li>
									<li><a href="#"><i class="fa fa-palette"></i></a></li>
								</ul>	
								<ul class="actions">
									<li><a href="#"><i class="fa fa-hand-holding-usd"></i></a></li>
									<li><a href="#"><i class="fa fa-keyboard"></i></a></li>
									<li><a href="#"><i class="fab fa-youtube"></i></a></li>
									<li><a href="#"><i class="fa fa-globe-americas"></i></a></li>
								</ul>
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="row cn-slider">
											<div class="col-md-6">
												<div class="cn-img">
													<img src="${pageContext.request.contextPath}/resources/assets_main/img/news-350x223-1.jpg" />
													<div class="cn-title">
											...
											<div class="col-md-6">
												<div class="cn-img">
													<img src="${pageContext.request.contextPath}/resources/assets_main/img/news-350x223-2.jpg" />
													<div class="cn-title">
														<a href="">Lorem ipsum dolor sit</a>
													</div>
												</div>
											...
											<div class="col-md-6">
												<div class="cn-img">
													<img src="${pageContext.request.contextPath}/resources/assets_main/img/news-350x223-3.jpg" />
													<div class="cn-title">
														<a href="">Lorem ipsum dolor sit</a>
													</div>
												</div>
									...
									<div class="col-md-6">
										...
										<div class="row cn-slider">
											<div class="col-md-6">
												<div class="cn-img">
													<img src="${pageContext.request.contextPath}/resources/assets_main/img/news-350x223-4.jpg" />
													<div class="cn-title">
														<a href="">Lorem ipsum dolor sit</a>
													</div>
												</div>
											...
											<div class="col-md-6">
												<div class="cn-img">
													<img src="${pageContext.request.contextPath}/resources/assets_main/img/news-350x223-5.jpg" />
													<div class="cn-title">
														<a href="">Lorem ipsum dolor sit</a>
													</div>
												</div>
